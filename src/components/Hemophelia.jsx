...
const HemophiliaInfo = () => {
  ...
  const images = {
    intro: "https://tse2.mm.bing.net/th?id=OIP.8eGua-f2Pk5ec7l-GofUPgHaE8&pid=Api",
    symptoms: "https://tse1.mm.bing.net/th?id=OIP.O-6KyCUhOyO3IuyarBieOgHaHa&pid=Api",
    treatment: "https://tse3.mm.bing.net/th?id=OIP.wbfgnq0mKCkWoEyC7ZIKcQHaFr&pid=Api",
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white shadow-lg rounded-lg">
      ...
      {/* Types */}
      <h2 className="text-2xl font-semibold text-red-500 mb-4">हिमोफीलिया के प्रकार</h2>
      ...
      <div className="mb-8">
        <button
          className="w-full text-left text-xl font-semibold text-red-600 hover:text-red-800"
        ...
        {isTreatmentOpen && (
          <div className="mt-4">
            ...
            <p className="text-lg text-gray-700 mt-4">
              हिमोफीलिया का उपचार क्लॉटिंग फैक्टर रिप्लेसमेंट थेरेपी के माध्यम से किया जाता है। 
              इसके अतिरिक्त, डेस्मोप्रेसिन और फिजिकल थेरेपी का भी उपयोग किया जा सकता है। 
              नई तकनीकों जैसे जीन थेरेपी पर शोध जारी है।
            </p>
          </div>
        )}
      </div>
      ...
      {/* Lifestyle Tips */}
      <h2 className="text-2xl font-semibold text-red-500 mb-4">जीवनशैली सुझाव</h2>
      <ul className="list-disc pl-6 mb-8 text-gray-700">
        <li>चोटों से बचने के लिए सावधानी बरतें।</li>
        <li>नियमित चिकित्सकीय जांच कराएं।</li>
        <li>रक्तस्राव के संकेतों पर ध्यान दें और आवश्यकतानुसार उपचार करें।</li>
      </ul>

      {/* Disclaimer */}
      <p className="text-lg text-gray-700">
        <strong>नोट:</strong> यह जानकारी केवल शैक्षिक उद्देश्यों के लिए है। 
        किसी भी चिकित्सा समस्या के लिए अपने डॉक्टर से परामर्श करें।
      </p>
